...
class GovernanceIntegrityManager:
    ...
    def create_signature_record(
        self, file_path: str, signer_id: str = "L9Governance_System"
    ) -> dict:
        """
    ...
    def sign_all_governance_files(self, signer_id: str = "L9Governance_System") -> dict[str, bool]:
        ...
        governance_dirs = ["intelligence", "foundation", "execution", "operations", "environment"]
    ...
    def get_signature_status(self, file_path: str) -> dict:
        ...
        if not signature_file.exists():
            return {"signed": False, "file": file_name, "message": "No signature found"}
