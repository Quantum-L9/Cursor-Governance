...
class TelemetryCollector:
    ...
    def collect_event(
        self, component_id: str, event_type: str, event_data: dict[str, Any], severity: str = "info"
    ):
    ...
    def get_performance_summary(self, component_id: str = None, hours: int = 24) -> dict[str, Any]:
        ...
        summary = {
            ...
            "avg_duration_ms": sum(
                p["avg_duration"] * p["operation_count"] for p in performance_data
            )
