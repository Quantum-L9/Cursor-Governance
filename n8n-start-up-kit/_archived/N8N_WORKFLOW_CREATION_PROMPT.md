...
**Compatible with:** n8n-mcp v2.17.0+
...
|----------|---------|-------------|
| **[N8N_NODE_VALIDATION_PROTOCOL.md](N8N_NODE_VALIDATION_PROTOCOL.md)** | Complete reference guide | When you need detailed information about MCP servers, tools, and validation |
| **[N8N_WORKFLOW_CREATION_PROMPT.md](N8N_WORKFLOW_CREATION_PROMPT.md)** | AI prompt template ← **YOU ARE HERE** | When asking AI to create n8n workflows (copy-paste prompt) |
| **[CONTEXT7_N8N_INTEGRATION_GUIDE.md](CONTEXT7_N8N_INTEGRATION_GUIDE.md)** | Context7 + n8n integration | When you need up-to-date n8n/API documentation |
| **[N8N_PROTOCOL_GAP_ANALYSIS.md](N8N_PROTOCOL_GAP_ANALYSIS.md)** | Development history | Understanding what was added and why |
| **[N8N_QUICK_START.md](N8N_QUICK_START.md)** | 5-minute quick start | When you want a working example immediately |
...
**Goal:** Understand node behavior and best practices with CURRENT documentation

**MCP Resources to Query:**
1. **`tools_documentation`** - Get detailed node documentation (from n8n-mcp)
2. **Context7 MCP** - Get up-to-date n8n documentation (if available)
...
- Ensures you get CURRENT n8n documentation (not outdated from AI training)
- Validates latest authentication patterns
- Catches deprecated parameters
- Provides version-specific examples

**Learn More:** See [CONTEXT7_N8N_INTEGRATION_GUIDE.md](CONTEXT7_N8N_INTEGRATION_GUIDE.md) for complete Context7 usage patterns
...
Retrieve detailed documentation for each node:
- Usage examples
- Best practices
- Authentication requirements
- Common configurations

**Query MCP resource:** `tools_documentation`
