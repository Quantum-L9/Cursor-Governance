...
version: "6.0.0"
component_id: "INT-N8N-004"
component_name: "n8n Node Validation Protocol"
layer: "intelligence"
...
integrates_with: ["INT-N8N-002", "INT-N8N-003"]
api_endpoints: []
...
# === BUSINESS METADATA ===
purpose: "Complete technical reference for n8n MCP validation and troubleshooting"
summary: "Comprehensive guide covering MCP servers, tools, validation protocols, and error resolution"
business_value: "Ensures zero-error workflow creation through systematic validation and troubleshooting"
success_metrics: ["validation_accuracy >= 0.95", "error_resolution_time < 5min"]

# === TAGS & CLASSIFICATION ===
tags: ["n8n", "workflow", "validation", "mcp", "troubleshooting", "technical-reference"]
keywords: ["n8n", "validation", "mcp", "protocol", "troubleshooting", "technical"]
...
**Priority:** Secondary reference (use when official docs.n8n.io unavailable or need code-level details)
...
**Note:** Official docs.n8n.io takes precedence over Context7. Always check official docs first.
...
**Learn More:** See [03_CONTEXT7_REFERENCE.md](03_CONTEXT7_REFERENCE.md) for complete integration patterns

---

### Recommended Setup: Use All Three Servers + Official Docs

**Documentation Priority Order:**
1. **Official docs.n8n.io** ← **HIGHEST PRIORITY - TRUMPS ALL** (Authoritative examples and best practices)
2. **n8n-mcp (Type A)**: Provides node structure and schemas (validates against your instance)
3. **Context7 (Type C)**: Ensures current documentation and no deprecated code ← **Secondary reference**

**Why use all three?**
1. **Official docs.n8n.io**: Authoritative source for n8n-recommended patterns and examples
2. **n8n-mcp (Type A)**: Provides node structure and schemas
3. **n8n Instance MCP (Type B)**: Manages your actual workflows
4. **Context7 (Type C)**: Ensures current documentation and no deprecated code (use when official docs unavailable)
