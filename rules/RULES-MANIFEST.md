...
Generated: `2026-09-20T03:30:01Z`. Source: `rules/*.mdc`.
...
| `03-graphiti-memory.mdc` | `l9.rule.graphiti.memory` | global | memory | always | 118 | `d696f599ed7e` |
...
| `07-max-velocity-research.mdc` | `l9.rule.07.max.velocity.research` | global | governance | always | 48 | `6ea31975c138` |
...
| `22-context7-auto-invoke.mdc` | `l9.rule.22.context7.auto.invoke` | global | git | always | 91 | `dd9454223e2c` |
...
| `48-make-pr-remediation.mdc` | `l9.rule.48.make.pr.remediation` | global | general | always | 160 | `267262444987` |
...
| `53-pr-overlap-guardrail.mdc` | `l9.rule.53.pr.overlap.guardrail` | global | git | always | 133 | `6370d6493baf` |
...
| `87-cursor-memory-kernel.mdc` | `l9.rule.cursor.memory.kernel` | global | memory | always | 211 | `975c9e6a79dc` |
...
| `97-graph-layer-boundary.mdc` | `l9.rule.graph-layer-boundary` | global | memory | always | 52 | `9d0d1ad1eda0` |
| `98-graphiti-memory-gate.mdc` | `l9.rule.graphiti.memory.gate` | global | memory | always | 79 | `f539c06c295b` |
| `99-no-auto-commit.mdc` | `l9.rule.git.mutation-gate` | global | git | always | 66 | `324bb7be214c` |
