...
Generated: `2026-09-24T04:20:15Z`. Source: `rules/*.mdc`.
...
| `03-graphiti-memory.mdc` | `l9.rule.graphiti.memory` | global | memory | always | 116 | `d01361deb4d7` |
...
| `87-cursor-memory-kernel.mdc` | `l9.rule.cursor.memory.kernel` | global | memory | always | 220 | `42753e091959` |
