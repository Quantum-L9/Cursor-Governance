...
Generated: `2026-08-30T02:03:37Z`. Source: `rules/*.mdc`.
...
| `22-context7-auto-invoke.mdc` | `l9.rule.22.context7.auto.invoke` | global | git | always | 74 | `ac701b392ee6` |
...
| `49-shared-worktree-isolation.mdc` | `l9.rule.49.shared.worktree.isolation` | global | git | always | 87 | `d4eee7f3416b` |
...
| `62-github-openclaw-authority.mdc` | `l9.rule.62.github.openclaw.authority` | global | git | always | 27 | `8083a57ba87c` |
