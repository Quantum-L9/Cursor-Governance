...
Generated: `2026-08-29T00:29:35Z`. Source: `rules/*.mdc`.
...
| `02-slash-commands.mdc` | `l9.rule.slash-commands` | global | governance | always | 160 | `b9fdef60fbe8` |
...
| `48-make-pr-remediation.mdc` | `l9.rule.48.make.pr.remediation` | global | general | always | 126 | `0d11190bad8d` |
