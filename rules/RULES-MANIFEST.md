...
Generated: `2026-09-15T13:37:28Z`. Source: `rules/*.mdc`.
...
| `03-graphiti-memory.mdc` | `l9.rule.graphiti.memory` | global | memory | always | 90 | `815aa99500c1` |
...
| `53-pr-overlap-guardrail.mdc` | `l9.rule.53.pr.overlap.guardrail` | global | git | always | 129 | `6de1f42606b1` |
...
| `87-cursor-memory-kernel.mdc` | `l9.rule.cursor.memory.kernel` | global | memory | always | 198 | `06cb2bf2a6e4` |
| `88-l4-local-autonomy.mdc` | `l9.rule.l4.local-autonomy` | global | git | always | 74 | `1cb82c2099d6` |
...
| `98-graphiti-memory-gate.mdc` | `l9.rule.graphiti.memory.gate` | global | memory | always | 77 | `d1f99f8bbcb9` |
