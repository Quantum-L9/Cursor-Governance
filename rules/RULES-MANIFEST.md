...
Generated: `2026-08-16T15:46:12Z`. Source: `rules/*.mdc`.
...
| `48-make-pr-remediation.mdc` | `l9.rule.48.make.pr.remediation` | global | general | always | 81 | `ed0ea396e335` |
...
| `88-l4-local-autonomy.mdc` | `l9.rule.l4.local-autonomy` | global | git | always | 57 | `5df9f0bd37ba` |
