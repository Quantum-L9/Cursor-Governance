...
Generated: `2026-09-14T21:23:43Z`. Source: `rules/*.mdc`.
...
| `03-graphiti-memory.mdc` | `l9.rule.graphiti.memory` | global | memory | always | 90 | `576640f67ed3` |
...
| `87-cursor-memory-kernel.mdc` | `l9.rule.cursor.memory.kernel` | global | memory | always | 198 | `bace62e5472e` |
