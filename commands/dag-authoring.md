...
dag_file: workflows/session/dags/dag_authoring_dag.py
...
```python
from workflows.session.dags import DAG_AUTHORING_DAG
...
- **DAG**: `workflows/session/dags/dag_authoring_dag.py`
