...
# .cursor-commands/learning/n8n-ai-agent-patterns.md
# .cursor-commands/learning/n8n-configs/EMAIL_NODE_CONFIGURATION_STANDARD.md
# .cursor-commands/learning/n8n-configs/SUPABASE_NODE_CONFIGURATION_GUIDE.md
...
# .cursor-commands/learning/n8n_lessons_learned/Recursive_Self_Check_Protocol.md
# .cursor-commands/learning/n8n_lessons_learned/Node_Research_Guide.md
# .cursor-commands/learning/n8n_lessons_learned/N8N_Execution_Protocol.md
# Expected: 12+ files across organized subdirectories
```

**MANDATORY Session Initialization Sequence:**

```
0. READ: @.cursor-commands/profiles/session-startup-protocol.md (FIRST)
   └─ Purpose: Session initialization checklist and governance activation sequence
   └─ Mode Type: Protocol
   └─ Component: PRF-SSP-001
   └─ Duration: 2 minutes
   └─ Skip: NEVER
   └─ Note: Master checklist for session startup - ensures nothing is missed
   └─ Use For: Every session start to validate complete initialization
...
1.5. READ: @.cursor-commands/startup/REASONING_STACK.yaml (MANDATORY)
   └─ Purpose: Activate all reasoning, learning, and quality systems (L9 Multi-Modal, Recursive Learning, Mistake Prevention, Pattern Detection, Error Correction, 10 Power Commands)
   └─ Component: REASONING-STACK-001
   └─ Duration: 30 seconds
   └─ Skip: NEVER
   └─ Note: Minimal-footprint YAML load pack activating all reasoning capabilities. Loads: Multi-modal reasoning, Modular blocks, Recursive learning (5 mechanisms), Mistake prevention (zero tolerance), Technical operations (5-phase), Pattern detection (4 types), Error correction (3-phase), Universal development principles, 10 power commands
   └─ Activation: AI responds with "✅ Reasoning Stack ACTIVATED - All systems operational"
   └─ Use For: All reasoning tasks, complex problem-solving, technical decisions, pattern detection, error handling

2. READ: ALL files in .cursor-commands/learning/ folder (recursive, GlobalCommands)
   └─ Purpose: Load ALL learning files from GlobalCommands (failures, patterns, solutions, n8n lessons, n8n configs)
   └─ Method: Read every .md file found recursively in .cursor-commands/learning/
   └─ Key Files Include:
      - credentials-policy.md (security policy)
      - failures/repeated-mistakes.md (mistake prevention)
      - n8n-ai-agent-patterns.md (AI agent patterns)
      - n8n-configs/EMAIL_NODE_CONFIGURATION_STANDARD.md (email node setup)
      - n8n-configs/SUPABASE_NODE_CONFIGURATION_GUIDE.md (Supabase node setup)
      - patterns/quick-fixes.md (quick solutions)
      - solutions/authentication-fixes.md (auth solutions)
      - solutions/json-issues.md (JSON parsing solutions)
      - n8n_lessons_learned/Recursive_Self_Check_Protocol.md (validation protocol)
      - n8n_lessons_learned/Node_Research_Guide.md (research methodology)
      - n8n_lessons_learned/N8N_Execution_Protocol.md (execution checklist)
   └─ Duration: 4-5 minutes (all 12+ files)
   └─ Skip: NEVER
   └─ Note: This is the GlobalCommands learning folder (via symlink) - loads ALL subdirectories

2.5. READ: n8n Start-Up Kit files (MANDATORY for n8n workflow development)
   └─ Purpose: Load complete n8n MCP validation system and workflow creation guides
   └─ Files (7 active files):
      - @.cursor-commands/n8n-start-up-kit/01_README.md (overview & navigation)
      - @.cursor-commands/n8n-start-up-kit/02_WORKFLOW_CREATION.md (5-phase creation process)
      - @.cursor-commands/n8n-start-up-kit/03_CONTEXT7_REFERENCE.md (Context7 MCP integration)
      - @.cursor-commands/n8n-start-up-kit/04_VALIDATION_PROTOCOL.md (zero-error validation)
      - @.cursor-commands/n8n-start-up-kit/05_SYSTEM_ARCHITECTURE.md (architecture patterns)
      - @.cursor-commands/n8n-start-up-kit/06_QUICK_START.md (5-minute quick start)
      - @.cursor-commands/n8n-start-up-kit/n8n_api_helper.py (Python helper script)
   └─ Duration: 5 minutes (all files)
   └─ Skip: NEVER
   └─ Note: Complete production-ready n8n workflow system with MCP validation
   └─ Use For: n8n workflow creation, node validation, MCP tool usage, Context7 integration
...
4. READ: @.cursor-commands/startup/system_capabilities.md (MANDATORY)
   └─ Purpose: Inventory available reasoning systems, tools, and capabilities
   └─ Component: DOC-CAP-001
   └─ Duration: 3 minutes
   └─ Skip: NEVER
   └─ Note: CRITICAL for self-awareness - know what Bayesian engines, learning systems exist
   └─ Contains: Probabilistic engines, intelligence systems, slash commands, integration patterns
   └─ Why: Prevents "I don't have X" when X exists in foundation/logic/

4.5. READ: @.cursor-commands/startup/probabilistic_governance_activated.md (MANDATORY)
   └─ Purpose: Understand probabilistic governance system capabilities and activation status
   └─ Component: FND-LG-004
   └─ Duration: 2 minutes
   └─ Skip: NEVER
   └─ Note: Learn about Bayesian probabilistic engine, hybrid reasoning kernel, self-calibrating learning
   └─ Contains: Risk assessment, subjective logic, auto-calibration, performance benchmarks
   └─ Why: Know how to use probabilistic reasoning for uncertainty, risk, and evidence combination

4.6. READ: @.cursor-commands/startup/production_speed_pack.md (MANDATORY)
   └─ Purpose: Access production-ready code templates and patterns for rapid development
   └─ Component: DEV-SPD-001
   └─ Duration: 2 minutes
   └─ Skip: NEVER
   └─ Note: Code templates, refactoring patterns, performance optimization, debugging strategies
   └─ Contains: FastAPI/React/SQL templates, optimization patterns, debugging approaches
   └─ Why: Accelerate development velocity while maintaining production quality

4.7. READ: @.cursor-commands/intelligence/pre-build-question-framework.md (MANDATORY)
   └─ Purpose: Strategic consultant questions to ask before major implementations
   └─ Mode Type: Framework
   └─ Component: INT-PBQ-001
   └─ Duration: 2 minutes
   └─ Skip: NEVER
   └─ Note: 5-10 strategic questions for /forge mode and heavy builds
   └─ Contains: Use case priority, data availability, latency tolerance, complexity preferences
   └─ Use For: /forge mode activation, major builds, significant implementations

4.8. READ: @.cursor-commands/intelligence/standards/production-quality-standards.md
   └─ Purpose: Production-ready code standards and quality benchmarks
   └─ Mode Type: Standards
   └─ Component: INT-STD-001
   └─ Duration: 2 minutes
   └─ Skip: Only if time-constrained
   └─ Note: Quality standards, code review criteria, production readiness checklist
   └─ Use For: Code quality validation, production deployments, quality assurance

5. READ: @.cursor-commands/profiles/reasoning_n8n.md
   └─ Purpose: Enable n8n-specific reasoning capabilities
   └─ Mode Type: Reasoning
   └─ Component: INT-RSN-001
   └─ Duration: 2 minutes
   └─ Skip: NEVER
   └─ Use For: Building/debugging n8n workflows, selecting n8n tools

6. READ: @.cursor-commands/profiles/reasoning_docs.md
...
7. READ: @.cursor-commands/profiles/reasoning_technical_operations.md
...
10.5. READ: @.cursor-commands/commands/ynp.md
   └─ Purpose: Enable /ynp slash command - YNP Mode activation
   └─ Mode Type: Command
   └─ Component: CMD-001
   └─ Duration: 1 minute
   └─ Skip: NEVER
   └─ Use For: Activating YNP mode with /ynp command (strategic co-pilot)
...
15. READ: @.cursor-commands/profiles/workflow-governance.md
   ...
   └─ Duration: 1 minute
   └─ Skip: NEVER
   └─ Use For: n8n workflow validation and governance
...
20. READ: @.cursor-commands/foundation/logic/rule-registry.json
   ...
   └─ Duration: 30 seconds
   └─ Skip: NEVER
   └─ Use For: Governance rules and validation rules lookup
```

**Verification**: Post confirmation after loading
```
✅ Session initialized
   - Session Startup Protocol LOADED (master checklist)
   - Governance rules loaded (.cursorrules workspace root AND GlobalCommands template)
   - Reasoning Stack ACTIVATED (startup/REASONING_STACK.yaml - all reasoning capabilities enabled)
   - ALL GlobalCommands learning files loaded (.cursor-commands/learning/ - recursive)
   - Pending Lessons CHECKED (medium-quality and low-quality lessons reviewed)
   - n8n Start-Up Kit ENABLED (7 files: README, workflow creation, Context7, validation, architecture, quick-start, helper)
   - System Capabilities LOADED (Bayesian engine, hybrid kernel, intelligence systems)
   - Probabilistic Governance LOADED (risk assessment, self-calibration, subjective logic)
   - Production Speed Pack LOADED (code templates, refactoring patterns, optimization)
   - Pre-Build Questions LOADED (strategic consultant framework)
   - Production Quality Standards LOADED (quality benchmarks)
   ...
   - Slash Commands ENABLED (/reasoning, /ynp, /forge, /consolidate, /analyze-toolkit, /evaluate)
...
## STEP 1.5.5: Review Pending Lessons (RECOMMENDED)

**⚠️ Check for lessons awaiting your review from the Formal Lesson Extractor:**

```bash
# Check if there are pending lessons to review
if [ -f ".cursor-commands/learning/failures/lessons_review_log.jsonl" ]; then
    PENDING_COUNT=$(wc -l < .cursor-commands/learning/failures/lessons_review_log.jsonl)
    if [ "$PENDING_COUNT" -gt 0 ]; then
        echo "⚠️  MEDIUM-QUALITY LESSONS PENDING REVIEW ($PENDING_COUNT)"
        echo "════════════════════════════════════════════════════"
        cat .cursor-commands/learning/failures/lessons_review_log.jsonl | python3 -c "
import json, sys
for i, line in enumerate(sys.stdin, 1):
    lesson = json.loads(line)
    print(f'\n{i}. {lesson[\"lesson_id\"]} (Score: {lesson[\"quality_score\"]})')
    print(f'   Status: {lesson[\"status\"]}')
    content = lesson['lesson_content']
    print(f'   Mistake: {content.get(\"mistake\", \"N/A\")}')
    print(f'   Impact: {content.get(\"impact\", \"N/A\")}')
    print(f'   Prevention: {content.get(\"prevention\", \"N/A\")}')
"
        echo ""
        echo "📋 To approve/improve: python3 .cursor-commands/ops/scripts/formal_lesson_extractor.py --weekly-review"
        echo ""
    else
        echo "✅ No medium-quality lessons pending review"
    fi
else
    echo "✅ No medium-quality lessons pending review"
fi

# Check for low-quality lessons that were rejected
if [ -f ".cursor-commands/learning/failures/audit_log.jsonl" ]; then
    REJECTED_COUNT=$(grep -c '"quality_score"' .cursor-commands/learning/failures/audit_log.jsonl 2>/dev/null || echo "0")
    if [ "$REJECTED_COUNT" -gt 0 ]; then
        echo ""
        echo "ℹ️  LOW-QUALITY LESSONS IN AUDIT LOG ($REJECTED_COUNT)"
        echo "════════════════════════════════════════════════════"
        cat .cursor-commands/learning/failures/audit_log.jsonl | python3 -c "
import json, sys
for i, line in enumerate(sys.stdin, 1):
    lesson = json.loads(line)
    print(f'\n{i}. {lesson[\"lesson_id\"]} (Score: {lesson[\"quality_score\"]})')
    print(f'   Reason: Too generic or insufficient detail')
    print(f'   Pattern count: {lesson.get(\"pattern_count\", \"N/A\")}')
    if 'lesson_content' in lesson:
        content = lesson['lesson_content']
        print(f'   Content: {content.get(\"mistake\", \"N/A\")[:100]}...')
"
        echo ""
        echo "📄 These were rejected but logged for reference"
        echo "ℹ️  Consider manual extraction if patterns seem important"
        echo ""
    fi
fi
```
...
|------|----------|---------------|
| `lessons_review_log.jsonl` | Medium-quality lessons (0.70-0.85) | ⚠️ **Review recommended** - Already active, but could be improved |
| `audit_log.jsonl` | Low-quality lessons (<0.70) | ℹ️ **Optional review** - Rejected but logged for reference |

**Quality Thresholds:**
- **High (≥0.85):** Auto-added, no review needed ✅
- **Medium (0.70-0.85):** Auto-added + flagged for review ⚠️
- **Low (<0.70):** Rejected + logged to audit ❌

**Review Commands:**
```bash
# View medium-quality lessons (pending review)
cat .cursor-commands/learning/failures/lessons_review_log.jsonl | python3 -m json.tool

# View low-quality lessons (rejected)
cat .cursor-commands/learning/failures/audit_log.jsonl | python3 -m json.tool

# Run formal lesson extraction to process new patterns
python3 .cursor-commands/ops/scripts/formal_lesson_extractor.py --weekly-review
```

**✅ Success Check**: Pending lessons reviewed or noted for later review
...
1. **reasoning_n8n.md** - n8n Agent Reasoning Profile
   - **When to use:** Building n8n workflows, debugging agents, selecting n8n tools
...
## STEP 3.5: Activate Learning & Context-Memory Systems

**⚠️ CRITICAL:** Activate BOTH intelligence systems for full AI continuity

### A. Learning System (Pattern & Mistake Extraction)
...
[Date Time] Step 1/4: Running Memory Aggregator...
🚀 Memory Aggregator v2.0.0 - Starting...

📂 Found X chat export directories
✅ Processing complete! Total learnings: X

[Date Time] Step 2/4: Updating Learning Files...
📚 Learning File Updater v1.0.0 - Starting...
✅ No pending learnings to apply

[Date Time] Step 3/4: Syncing to Meta-Learning Log...
🔄 Meta Learning Syncer v1.0.0 - Starting...
✅ Synced X learnings to meta-learning-log.md

[Date Time] Step 4/4: Syncing to .cursorrules...
...
- ✅ Syncs learnings to `intelligence/meta-learning/meta-learning-log.md` (NEW - FIXED)
- ✅ Syncs repeated mistakes to `.cursorrules` for AI auto-loading
- ✅ Creates/updates `ops/logs/memory_index.json`

### B. Context-Memory System (Session State & Continuity) ⭐ NEW

**Trigger the context-memory system to capture current session context:**

```bash
# Run the context processor manually to test the system
bash "/Users/ib-mac/Dropbox/Cursor Governance/GlobalCommands/ops/scripts/process_context.sh"
```

**Expected Output:**
```
✅ Context saved: 2025-11-08-18.json
✅ Context extracted: [project-name] - [summary]
```

**What This Does:**
- ✅ Extracts session context from chat exports
- ✅ Captures: project, actions, decisions, files modified, next steps
- ✅ Saves to `intelligence/context-memory/sessions/`
- ✅ Creates session index for quick lookup
- ✅ Enables instant context restoration on session start

**Verify Intelligence Systems Status:**
```bash
# Check if LaunchAgents are running (automatic hourly processing)
launchctl list | grep -E "tenx|learning|chat|context"

# Expected output:
# -    0    com.tenx.chat-export
# -    0    com.tenx.learning-processor
# -    0    com.cursor.context.processor
...
| **Context Processor** (OPS-CTX-001) | ✅ Hourly | Every 3600s | Extracts session context & state | ops/scripts/process_context.sh |
...
| **Meta-Learning Sync** (OPS-MLS-001) | ✅ Auto | On-demand | Syncs to meta-learning-log.md | ops/scripts/sync_to_meta_learning.py |
...
|-----------|-----|---------|----------|
| **MCP Cleanup** | OPS-MCP-001 | Remove stale n8n-mcp containers | ops/scripts/cleanup_mcp_containers.sh |
...
**✅ Success Check**: 
- Learning pipeline completes without errors (4 steps including meta-learning sync)
- Context processor captures session successfully
- LaunchAgents show status code `0` (running) - ALL THREE active
- Learning files updated in `.cursor-commands/learning/`
- Context sessions created in `.cursor-commands/intelligence/context-memory/sessions/`
- Memory index created/updated
- Session index created in context-memory
...
# Expected: List of profile files (reasoning_n8n.md, orchestrator.md, etc.)

# Check learning files (GlobalCommands learning folder)
ls .cursor-commands/learning
# Expected: failures/, patterns/, solutions/, n8n_lessons_learned/, n8n-configs/, etc.

# Count ALL learning files recursively (MANDATORY)
find .cursor-commands/learning/ -type f -name "*.md" 2>/dev/null | wc -l
# Expected: 12+ files (all .md files in GlobalCommands learning folder with Suite 6 structure)

# Count n8n start-up kit files (MANDATORY)
find .cursor-commands/n8n-start-up-kit/ -type f \( -name "*.md" -o -name "*.py" \) 2>/dev/null | wc -l
# Expected: 7+ files (n8n MCP complete system: README, workflow creation, Context7, validation, architecture, quick-start, helper)
...
test -f ".cursor-commands/learning/n8n-ai-agent-patterns.md" && echo "✅ n8n patterns accessible" || echo "❌ Missing"
...
test -d ".cursor-commands/learning/n8n_lessons_learned" && echo "✅ n8n lessons folder accessible (3 files)" || echo "❌ Missing"
test -d ".cursor-commands/learning/n8n-configs" && echo "✅ n8n configs folder accessible (2 files)" || echo "❌ Missing"

# Verify n8n start-up kit files exist (MANDATORY for n8n workflow development)
test -f ".cursor-commands/n8n-start-up-kit/01_README.md" && echo "✅ n8n README accessible" || echo "❌ Missing"
test -f ".cursor-commands/n8n-start-up-kit/02_WORKFLOW_CREATION.md" && echo "✅ n8n Workflow Creation accessible" || echo "❌ Missing"
test -f ".cursor-commands/n8n-start-up-kit/03_CONTEXT7_REFERENCE.md" && echo "✅ n8n Context7 Reference accessible" || echo "❌ Missing"
test -f ".cursor-commands/n8n-start-up-kit/04_VALIDATION_PROTOCOL.md" && echo "✅ n8n Validation Protocol accessible" || echo "❌ Missing"
test -f ".cursor-commands/n8n-start-up-kit/05_SYSTEM_ARCHITECTURE.md" && echo "✅ n8n System Architecture accessible" || echo "❌ Missing"
test -f ".cursor-commands/n8n-start-up-kit/06_QUICK_START.md" && echo "✅ n8n Quick Start accessible" || echo "❌ Missing"
test -f ".cursor-commands/n8n-start-up-kit/n8n_api_helper.py" && echo "✅ n8n API Helper accessible" || echo "❌ Missing"

# Verify startup files are accessible (MANDATORY for session startup)
test -f ".cursor-commands/startup/REASONING_STACK.yaml" && echo "✅ Reasoning Stack YAML accessible" || echo "❌ Missing"
test -f ".cursor-commands/startup/system_capabilities.md" && echo "✅ System capabilities accessible" || echo "❌ Missing"
test -f ".cursor-commands/startup/probabilistic_governance_activated.md" && echo "✅ Probabilistic governance accessible" || echo "❌ Missing"
test -f ".cursor-commands/startup/production_speed_pack.md" && echo "✅ Production speed pack accessible" || echo "❌ Missing"

# Verify intelligence framework files are accessible (MANDATORY for /forge mode)
test -f ".cursor-commands/intelligence/pre-build-question-framework.md" && echo "✅ Pre-build questions accessible" || echo "❌ Missing"
test -f ".cursor-commands/intelligence/standards/production-quality-standards.md" && echo "✅ Production quality standards accessible" || echo "❌ Missing"

# Verify reasoning profiles are accessible (MANDATORY for session startup)
test -f ".cursor-commands/profiles/reasoning_n8n.md" && echo "✅ n8n reasoning profile accessible" || echo "❌ Missing"
...
test -f ".cursor-commands/commands/ynp.md" && echo "✅ /ynp command accessible" || echo "❌ Missing"
...
test -f ".cursor-commands/commands/analyze.md" && echo "✅ /analyze-toolkit command accessible" || echo "❌ Missing"
test -f ".cursor-commands/commands/evaluate.md" && echo "✅ /evaluate command accessible" || echo "❌ Missing"
...
test -f ".cursor-commands/profiles/reasoning_n8n.md" && echo "✅ Reasoning profiles accessible" || echo "❌ Missing reasoning profiles" && \
...
✅ GlobalCommands learning files: 12
✅ n8n start-up kit files: 7
=== SETUP COMPLETE ===
```
...
- ✅ Session Startup Protocol accessible (`.cursor-commands/profiles/session-startup-protocol.md`)
- ✅ Reasoning Stack YAML accessible (`.cursor-commands/startup/REASONING_STACK.yaml`) - activates all reasoning capabilities
- ✅ GlobalCommands learning folder (`.cursor-commands/learning/`) accessible with all files
- ✅ n8n Start-Up Kit folder (`.cursor-commands/n8n-start-up-kit/`) accessible with 7 files (complete MCP system)
- ✅ Intelligence framework files accessible (pre-build-question-framework.md, production-quality-standards.md)
- ✅ Reasoning profiles accessible (reasoning_n8n.md, reasoning_docs.md, reasoning_technical_operations.md)
- ✅ Standard operating modes accessible (ynp_mode.md, dev_mode.md, orchestrator.md)
- ✅ Slash commands accessible (/reasoning, /ynp, /forge, /consolidate, /analyze-toolkit, /evaluate)
...
- ✅ **Learning system activated** (process_learnings.sh completed with 4 steps including meta-learning sync)
- ✅ **Context-memory system activated** (process_context.sh captured first session)
- ✅ **LaunchAgents running** (chat-export, learning-processor, AND context-processor showing status 0)
- ✅ **Memory index created** (ops/logs/memory_index.json exists)
- ✅ **Session index created** (intelligence/context-memory/sessions/index.json exists)
...
### Intelligence Systems (Automated Hourly)

**Dual Intelligence Architecture:**
1. **Learning System** - Extracts patterns, mistakes, solutions from conversations
2. **Context-Memory System** - Captures session state, decisions, project continuity

Both run hourly automatically via LaunchAgents. Together they provide:
- ✅ **Pattern Learning** - What works, what doesn't (cumulative wisdom)
- ✅ **Session Memory** - What you were doing, where you left off (continuity)
- ✅ **Decision Log** - Why choices were made (rationale preservation)
- ✅ **Project State** - Current status, next steps (no cold starts)

**Example Benefit:**
```
Without Context-Memory:
  User: "Let's continue with Mack v7.0"
  AI: "What were we working on? Let me search..."
  [5 minutes of catching up]

With Context-Memory:
  User: "Let's continue with Mack v7.0"
  AI: "Last session (Nov 7): Completed BCP Intelligence agent.
       Status: 3/5 agents done. Next: Offer Drafting Agent.
       Ready to continue?"
...
│   │   ├── context-memory/ ✅ Session state & continuity
│   │   │   ├── context-extractor.py
│   │   │   ├── sessions/ (hourly snapshots)
...
Note: `.cursor-commands/learning/` ✅ Symlink to GlobalCommands/learning (MANDATORY to read ALL files at session start)
  ...
  ├── n8n-configs/
  │   ├── EMAIL_NODE_CONFIGURATION_STANDARD.md
  │   └── SUPABASE_NODE_CONFIGURATION_GUIDE.md
  ├── n8n_lessons_learned/
  │   ├── Recursive_Self_Check_Protocol.md
  │   ├── Node_Research_Guide.md
  │   └── N8N_Execution_Protocol.md
  ├── patterns/
  │   └── quick-fixes.md
  └── solutions/
...
Note: `.cursor-commands/n8n-toolkit/` ✅ n8n MCP Toolkit (MANDATORY for n8n workflow development)
  ├── N8N_QUICK_START.md
  ├── N8N_NODE_VALIDATION_PROTOCOL.md
  └── N8N_WORKFLOW_CREATION_PROMPT.md
```
...
```
@.cursor-commands/profiles/reasoning_n8n.md
   └─ Use for: n8n workflow development, debugging, tool selection
   └─ Component: INT-RSN-001
...
2️⃣  Learning Subdirectory Structure:
   ...
   ✅ learning/n8n_lessons_learned/ exists
...
3️⃣  Core Learning Files:
   ...
   ✅ n8n-ai-agent-patterns.md exists
   ✅ n8n_lessons_learned/Recursive_Self_Check_Protocol.md exists

3.5️⃣  n8n Toolkit Files:
   ✅ n8n-toolkit/N8N_QUICK_START.md exists
   ✅ n8n-toolkit/N8N_NODE_VALIDATION_PROTOCOL.md exists
   ✅ n8n-toolkit/N8N_WORKFLOW_CREATION_PROMPT.md exists

3.6️⃣  n8n Configuration Standards:
   ✅ n8n-configs/EMAIL_NODE_CONFIGURATION_STANDARD.md exists
   ✅ n8n-configs/SUPABASE_NODE_CONFIGURATION_GUIDE.md exists

3.7️⃣  n8n Lessons Learned:
   ✅ n8n_lessons_learned/Recursive_Self_Check_Protocol.md exists
   ✅ n8n_lessons_learned/Node_Research_Guide.md exists
   ✅ n8n_lessons_learned/N8N_Execution_Protocol.md exists
...
7️⃣  LaunchAgent Services:
   Active services: 3 (Expected: 3)
   ✅ PASS (chat-export + learning-processor + context-processor)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   ...
   • 3 n8n toolkit files with Suite 6 headers
   • 5 learning system scripts with Suite 6 headers
   • 3 context-memory system scripts with Suite 6 headers
   • 3 utility scripts with Suite 6 headers
   • 3 LaunchAgent services running
...
**What This Verifies:**
- ✅ Learning folder has correct Suite 6 v6.0 structure (12+ files)
- ✅ All 5 subdirectories present (failures, patterns, solutions, n8n_lessons_learned, n8n-configs)
- ✅ All 12+ core learning files accessible
- ✅ n8n toolkit folder has 3 MCP validation files
- ✅ All 5 learning system scripts present
- ✅ All 3 context-memory system scripts present (process, install, show)
- ✅ All 3 utility scripts present (MCP cleanup, config fix, Docker verify)
- ✅ All 11+ scripts have Suite 6 canonical headers
- ✅ All THREE LaunchAgent services running (chat export + learning processor + context processor)
...
5. **Enable Intelligence Systems**: ✅ Already activated via STEP 3.5:
   - Learning System (process_learnings.sh) - Pattern extraction
   - Context-Memory System (process_context.sh) - Session continuity
