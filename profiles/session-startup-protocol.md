...
Task Type Decision Tree
    │
    ├─> L9 orchestration operation?
    │   └─> Go to: L9 Workflow Pattern (Section B)
    │
    ├─> Database operation?
...
## B. L9 Workflow Pattern

### Pre-Action Verification (MANDATORY)

**Before ANY L9 orchestration operation:**
...
```
WRONG:
  AI: "I'll use the L9 API key you provided earlier..."
  
RIGHT:
  AI: *reads Configuration/.env*
  AI: "Using L9_API_KEY from .env: eyJ..."
```
...
cat Configuration/.env | grep -E "L9_|SUPABASE_|API"
```
...
3. ✅ Check .suite6-config.json
4. ✅ Load Reasoning Mode profiles (L9, docs, technical operations)
