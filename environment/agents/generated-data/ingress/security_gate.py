...
def preflight(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    if size > 2_000_000:
        return {"safe": False, "classification": "TOO_LARGE", "finding_types": ["size"], "size": size}
    if findings:
        return {"safe": False, "classification": "SENSITIVE", "finding_types": ["secret_pattern"], "size": size}
