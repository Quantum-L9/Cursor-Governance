...
| SP-03 | Quality gate / PR gate PASS on changed files | `quality_gate` | e.g. `OPEN_PR=0 make pr` → PASS | true |
...
| EV-SP-03 | SP-03 | `quality_gate_evidence` | make-pr | `OPEN_PR=0 make pr` | PASS | `not_run` |
