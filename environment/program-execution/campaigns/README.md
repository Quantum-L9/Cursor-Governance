...
| `session-runtime-hydration-convergence-v2` | `campaign/session-runtime-hydration-convergence-v2` | 5 (session runtime; this repo) | planned |
...
## Campaign source format

Every live campaign source in this directory declares
`l9.program-execution.campaign-source.v2`. There is no compile allowlist: a
complete source is admitted by schema and semantic preflight. Retired v1
campaign inputs are preserved only under
`environment/program-execution/archive/campaign-input-v1/`; they are evidence,
never campaign ingress.
