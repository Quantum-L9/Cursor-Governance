...
**Status:** ready, **not started.** Live source is v1.1.0 (remaining Odoo
surface only). This pass does not bootstrap `pec` or apply mappers.

## Hosts

| Role | Repo | Branch |
|---|---|---|
| Campaign definition | `Quantum-L9/Cursor-Governance` | this overlay |
| Execution | `cryptoxdog/IB-Odoo_19` | `origin/Staging` |
