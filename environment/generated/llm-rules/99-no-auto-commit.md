...
3. **This rule** — Cursor **local commit** is standing and mandatory after authored edits. **Push / PR open** stays ask-first except when the user invoked `make pr` or a campaign packet / L4 authorize-release publish path applies
