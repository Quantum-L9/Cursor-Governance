...
# make pr → checkers + PR open (no remediation)
...
4. **Not** spawn `l9-pr-remediation` / poll workers.
5. **Not** merge.
...
human override only. The standing agent contract is no-remediate / no-merge.
