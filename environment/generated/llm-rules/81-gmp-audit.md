...
2. **Save to `/reports/`** with naming: `GMP-Report-<GMP-ID>.md`
...
- `reports/GMP-Report-111-Example-Description.md` — Full execution example
- `reports/GMP-Report-116-Example-Description.md` — Closed-loop learning example

**Rationale:** Reports provide audit trail and document changes for future reference.

<!-- generated-from: rules/81-gmp-audit.mdc; do-not-edit -->
