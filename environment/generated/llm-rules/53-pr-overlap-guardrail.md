...
instructions. Raw `git push` / `gh pr create` are off doctrine but not blocked
(CANONICAL_LAW §6.2.4); prefer `make pr` because it runs this gate, not because
the alternative errors.
