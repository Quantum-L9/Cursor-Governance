...
6. Do **not** run `l9-pr-remediation`, spawn a remediation poll worker, or merge.
...
- Merging any PR (including after program/plan Build)
- Spawning `l9-pr-remediation` after `make pr`
