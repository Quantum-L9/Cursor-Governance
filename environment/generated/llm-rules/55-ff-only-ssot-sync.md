...
An in-place catch-up leaves `.venv`, **env.local keep-list files**, and
unique untracked files. Unique commits and dirty tracked bytes are parked
...
not delete files to unblock. Keep-list: `.env.local`, `env.local`,
