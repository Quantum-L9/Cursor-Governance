---
description: Python rules for L9 pure-Python repos (src/ layout, uv). Not for Odoo addon suites — use the repo's Odoo Python overlay rule.
paths:
- src/**/*.py
- '!**/migrations/*.py'
---
...
> **Scope:** Applies when editing `src/**/*.py` in L9 services (uv, strict typing, async-first).
> **Excluded:** Odoo addon packages and migration scripts. Odoo repos use their own overlay rule.
...
<!-- generated-from: rules/20-lang-python.mdc; do-not-edit -->
