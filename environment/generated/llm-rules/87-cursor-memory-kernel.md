...
**Updated: 2026-08-06** *(resume-SSOT and tunnel wording superseded 2026-09-06)* — `memory-bank/` (former T0) is **deprecated/archival**. C1 L9 **decommissioned**. See `03-graphiti-memory.mdc` and `ops/graphiti/MEMORY_BANK_POLICY.md`.
