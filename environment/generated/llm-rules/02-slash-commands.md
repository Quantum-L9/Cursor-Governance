...
| `/ff` | `commands/ff.md` | Prove branch novelty, publish novel work, fast-forward, prune redundant |
...
| `/l9-plan-simple` | `commands/l9-plan-simple.md` | Shared executable-plan template, Cursor Build (`l9-plan-simple`) |
