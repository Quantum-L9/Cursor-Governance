...
class SetupConfig:
    ...
    MANDATORY_FILES = [
        ...
        {"file": "profiles/session-startup-protocol.md", "id": "PRF-SSP-001", "category": "Core Protocol"},
        {"file": ".cursorrules", "id": "RULES-001", "category": "Governance", "location": "workspace_root"},
        {"file": ".cursor-commands/templates/.cursorrules", "id": "RULES-002", "category": "Governance"},
        
        # Reasoning Activation (1 file)
        {"file": "startup/REASONING_STACK.yaml", "id": "REASONING-STACK-001", "category": "Reasoning", "activation": True},
        
        # Startup Files (5 files)
        {"file": "startup/system_capabilities.md", "id": "DOC-CAP-001", "category": "Startup"},
        {"file": "startup/probabilistic_governance_activated.md", "id": "FND-LG-004", "category": "Startup"},
        {"file": "startup/production_speed_pack.md", "id": "DEV-SPD-001", "category": "Startup"},
        {"file": "intelligence/pre-build-question-framework.md", "id": "INT-PBQ-001", "category": "Startup"},
        {"file": "intelligence/standards/production-quality-standards.md", "id": "INT-STD-001", "category": "Startup", "optional": True},
        
        # Reasoning Profiles (3 files)
        {"file": "profiles/reasoning_n8n.md", "id": "INT-RSN-001", "category": "Reasoning Profiles"},
        {"file": "profiles/reasoning_docs.md", "id": "INT-RSN-002", "category": "Reasoning Profiles"},
        {"file": "profiles/reasoning_technical_operations.md", "id": "INT-RSN-003", "category": "Reasoning Profiles"},
        ...
        {"file": "commands/reasoning.md", "id": "CMD-002", "category": "Slash Commands", "command": "/reasoning"},
        {"file": "commands/ynp.md", "id": "CMD-001", "category": "Slash Commands", "command": "/ynp"},
        {"file": "commands/forge.md", "id": "CMD-004", "category": "Slash Commands", "command": "/forge"},
        {"file": "commands/consolidate.md", "id": "CMD-005", "category": "Slash Commands", "command": "/consolidate"},
        {"file": "commands/analyze.md", "id": "CMD-006", "category": "Slash Commands", "command": "/analyze"},
        {"file": "commands/evaluate.md", "id": "CMD-007", "category": "Slash Commands", "command": "/evaluate"},
        ...
        {"file": "intelligence/meta-learning/meta-learning-log.md", "id": "INT-ML-001", "category": "Features"},
        {"file": "intelligence/reasoning/cursor-native-reasoning.md", "id": "INT-RE-001", "category": "Features"},
        {"file": "foundation/logic/universal-kernel.md", "id": "FND-LG-002", "category": "Features"},
...
class Suite6WorkspaceSetup:
    ...
    def _print_banner(self):
        ...
        print(f"{Colors.BOLD}Enforcement:{Colors.END} {Colors.RED}{Colors.BOLD}200%{Colors.END} {Colors.LOCK}\n")
    ...
    def _load_mandatory_files(self) -> bool:
        ...
        for i, file_config in enumerate(self.config.MANDATORY_FILES, 1):
            ...
            if file_config.get('activation'):
                print(f"   {Colors.CYAN}{Colors.BRAIN} Activating reasoning capabilities...{Colors.END}")
                time.sleep(0.1)  # Dramatic pause
                print(f"   {Colors.GREEN}{Colors.BOLD}✅ Reasoning Stack ACTIVATED - All systems operational{Colors.END}")
    ...
    def _load_learning_files(self) -> bool:
        ...
        print_info(f"Scanning learning directory recursively...")
    ...
    def _check_pending_lessons(self):
        ...
        if review_log.exists():
            try:
                ...
                if lessons:
                    print(f"{Colors.YELLOW}{Colors.BOLD}⚠️  MEDIUM-QUALITY LESSONS PENDING REVIEW ({len(lessons)}){Colors.END}")
                    ...
                    for i, lesson in enumerate(lessons, 1):
                        ...
                        print(f"{Colors.BOLD}{i}. {lesson_id}{Colors.END} {Colors.CYAN}(Score: {quality}){Colors.END}")
                        print(f"   {Colors.YELLOW}Mistake:{Colors.END} {content.get('mistake', 'N/A')}")
                        print(f"   {Colors.GREEN}Prevention:{Colors.END} {content.get('prevention', 'N/A')}")
                        print()
                    
                    print(f"{Colors.CYAN}📋 To improve: python3 .cursor-commands/ops/scripts/formal_lesson_extractor.py --weekly-review{Colors.END}\n")
                else:
        ...
        if audit_log.exists():
            try:
                ...
                if lessons:
                    print(f"{Colors.CYAN}ℹ️  LOW-QUALITY LESSONS IN AUDIT LOG ({len(lessons)}){Colors.END}")
    ...
    def _activate_intelligence(self) -> bool:
        ...
        systems = [
            ("Learning Processor", self.config.GLOBAL_COMMANDS / "ops/scripts/process_learnings.sh"),
            ("Context-Memory Processor", self.config.GLOBAL_COMMANDS / "ops/scripts/process_context.sh"),
        ]
        ...
        agents = ["com.tenx.chat-export", "com.tenx.learning-processor", "com.cursor.context.processor"]
    ...
    def _print_success(self):
        ...
        print(f"{Colors.BOLD}{Colors.GREEN}🚀 Ready to build with full governance support!{Colors.END}\n")
