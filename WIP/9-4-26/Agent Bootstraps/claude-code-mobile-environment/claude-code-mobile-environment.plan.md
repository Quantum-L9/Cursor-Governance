...
isProject: false
kernel_pass:
  bound_path: WIP/9-4-26/Agent Bootstraps/claude-code-mobile-environment/claude-code-mobile-environment.plan.md
  improve:
    kernel: kernels/Improve.md
    ran_at: 2026-09-04T14:56:00Z
    body_sha256: "1959c84a180942a1387289b90de0843fc279acc616758a533b01bbac09901c05"
    deltas:
      - "Shelved as dated WIP corpus only; no rewrite of the overlay tree"
      - "No promotion into live adapter or skill paths"
  recursive_alignment:
    kernel: kernels/Recursive Alignment.md
    ran_at: 2026-09-04T14:57:00Z
    body_sha256: "1959c84a180942a1387289b90de0843fc279acc616758a533b01bbac09901c05"
    deltas:
      - "Stays under WIP/; does not override live Claude mobile bootstrap on main"
  validate_repair:
    ...
    deltas:
      ...
      - "This stamp does not execute the mobile bootstrap plan"
---
