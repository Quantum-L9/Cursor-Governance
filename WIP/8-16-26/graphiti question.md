printf '%s' '{"session_id":"2d24e943-d55a-4484-aaed-52d9651c128c"}' | python3 environment/agents/adapters/claude-code/hooks/memory_prefetch.py
{"hookSpecificOutput": {"hookEventName": "SessionStart", "additionalContext": "L9 memory: ENFORCED via Cursor Graphiti hydrate (group_id=cursor-governance; namespaces cursor-governance). Rule 03-graphiti-memory; skill l9-graphiti-memory; CANONICAL_LAW \u00a78.\n### Graphiti hydrate\ngraphiti hydrate: group_id=cursor-governance agent_id=claude-code packet=1b0777e0902f8959\nobjective: continue work in Cursor-Governance and resume from the latest Graphiti PICKUP.\nnext=resume from the latest Graphiti PICKUP.\nstats: facts_returned=8 | pickup_parsed=yes | context_chars=616 | search_queries_used=1 | budget_chars=4000\nfacts_preview:\n- The active objective is to continue work in Cursor-Governance and resume from the latest Graphiti PICKUP.\n- The agent for the session with ID e47dc7ce-e1dd-44ba-84fb-4d969ff862e0 is claude-code.\n- The objective is to continue work in Cursor-Governance by resuming from the latest Graphiti PICKUP.\nfacts:\nThe active objective is to continue work in Cursor-Governance and resume from the latest Graphiti PICKUP.\n---\nThe active objective is to continue work in Cursor-Governance and resume from the latest Graphiti PICKUP.\n---\nThe agent for the session with ID e47dc7ce-e1dd-44ba-84fb-4d969ff862e0 is claude-code.\n---\nThe objective is to continue work in Cursor-Governance by resuming from the latest Graphiti PICKUP.\n---\nThe objective is to continue work in Cursor-Governance, resuming from the latest Graphiti PICKUP.\n---\nThe objective is to continue work in Cursor-Governance by resuming from the latest Graphiti PICKUP.\n```json\n{\"packet_id\": \"1b0777e0902f8959\", \"group_id\": \"cursor-governance\", \"agent_id\": \"claude-code\", \"active_objective\": \"continue work in Cursor-Governance and resume from the latest Graphiti PICKUP.\", \"next_action_contract\": {\"next_action\": \"resume from the latest Graphiti PICKUP.\", \"rationale\": \"Compiled from Graphiti PICKUP/facts at sessionStart\", \"blockers\": []}, \"degraded\": false, \"hydrate_stats\": {\"facts_returned\": 8, \"pickup_parsed\": true, \"context_chars\": 616, \"search_queries_used\": 1, \"budget_chars\": 4000, \"degraded\": false, \"degrade_reason\": \"\"}}\n```\nGoverned writes require a conflict-checked phase-lock via the same front door: python3 environment/agents/adapters/claude-code/hooks/memory_lock.py acquire --namespace cursor-governance --task \"<change>\"."}}
python3 environment/agents/adapters/claude-code/hooks/memory_lock.py acquire --namespace cursor-governance --task "revise peer_execution_core plan freshness 2026-08-14"
...
python3 environment/agents/adapters/claude-code/hooks/memory_lock.py acquire --namespace cursor-governance --task "revise peer_execution_core plan freshness 2026-08-14" --force
{
  "namespace": "cursor-governance",
  "conflicts": [
    {
...
}
{
  ...
  "graphiti": {
    ...
    "phase_lock": "granted",
    "state_file": "/Users/ib-mac/.cursor/graphiti-state/2d24e943-d55a-4484-aaed-52d9651c128c.json"
  },
  "namespace": "cursor-governance",
  "server_granted": true,
  "session_id": "2d24e943-d55a-4484-aaed-52d9651c128c",
  "task": "revise peer_execution_core plan freshness 2026-08-14",
  "transport": "cursor-graphiti-phase-lock"
}
name: Peer Execution Core
overview: "Land WIP/llm_peer_execution_core on feat/kernel-pack-new-branch-default (already cut from origin/main; doctrine is at d6fd081). Rebase onto origin/main, L9-harden the pack, ship ADRs 0017–0022, port with a governed additive-only porter, prove with conformance and make pr-check. Do not create feat/peer-execution-core. Do not run stock apply_pr_pack.py. Do not mutate WIP/Legal Defense."
...
todos:
Almost none of the port is built. The plan’s branch and SHA lock were stale. I revised peer_execution_core_b7c12d4c.plan.md in place.

Built (local only)

Doctrine text exists as d6fd081 on feat/kernel-pack-new-branch-default, and as dirty copies on this checkout. It is not on origin/main.
ADR-0017 is still free (catalog ends at 0016, plus the old duplicate 0007).
The pack is still untracked under WIP/llm_peer_execution_core/. Blocker tests were 7/7 on 2026-08-13.
Not built

No environment/program-execution/peer_execution/ — live tree still has adapters/common/.
No execution/adr tree, no ADR-0017–0022, no ADR-0001 supersession.
No porter rewrite, no land, no conformance / make pr-check for this port.
What was stale (now corrected in the plan)

This checkout is backup/local-unpushed-2026-08-14 @ fa4bf3f (= origin/main), not the landing branch.
The Improve-era lock (d6fd081 / 8c061c4, ahead 1 behind 1) is dead. The landing branch is 14 behind current main.
Wave 0 is rebase that named branch onto origin/main. Do not port on the backup branch.
Next action in the plan: Wave 0 — rebase feat/kernel-pack-new-branch-default onto origin/main. Do not apply the pack from this checkout.
