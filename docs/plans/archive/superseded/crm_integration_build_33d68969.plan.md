...
1. `[plasticos_facility_profile/models/res_partner.py](plasticos_facility_profile/models/res_partner.py)`
  ...
  ```
2. `[plasticos_intake/models/intake.py](plasticos_intake/models/intake.py)`
  - Same change for `lead_source_id`
3. `[plasticos_web_leads/models/web_lead.py](plasticos_web_leads/models/web_lead.py)`
...
| Type                                     | Internal logic  | Remit vs Location        |
| is_remit, is_invoice_entity, is_facility | Custom booleans | May need custom fields   |
| Alias                                    | `comment`       | Append to notes          |
...
| Company Type                   | `industry_id`                   | Via partner       |
| Materials                      | Material profile                | Link              |
| Notes                          | `description`                   | Notes             |
| Lead Source                    | `source_id`                     | utm.source        |
| Lat/Long                       | `partner_latitude/longitude`    | Geo               |
| Alias                          | `description`                   | Append            |
| SIC/NAICS                      | SKIP                            | Not needed        |
| Sales Volume, Employees, Sq Ft | SKIP                            | Not needed        |
...
| `x_delivery_term`        | automation       | FOB/Delivered        | YES   |
...
| `x_buyer_id`             | automation       | Buyer on PO          | YES   |
...
| `x_expiry_date`          | documents        | Doc expiry           | YES   |
| `x_version`              | documents        | Doc versioning       | YES   |


**Fields to REMOVE (this build):**

- `x_facility_role` → Migrate to `category_id`
