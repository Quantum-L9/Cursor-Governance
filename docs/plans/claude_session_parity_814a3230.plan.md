...
overview: Align Claude Code SessionStart with Cursor’s load card and per-session skill/rule heal. Shared renderer lives in ops/; the setup paste stays VM provision only. New branch from origin/main @ 577c482.
todos:
