...
# The projection engine keeps them in lockstep (claude_projection.py renders the
# env value from the same source as the registration), so a bump in one place
