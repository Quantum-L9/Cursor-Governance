...
- Every runtime script must be named in `SKILL.md` or a runtime reference. Source-only development validators may remain unlinked only when the packager excludes them from the runtime ZIP.
