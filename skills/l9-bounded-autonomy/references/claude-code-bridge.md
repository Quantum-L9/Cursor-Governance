...
```bash
python3 "$HOME/.cursor-governance/environment/claude-code/autonomy/cli.py" init <campaign.json>
python3 "$HOME/.cursor-governance/environment/claude-code/autonomy/cli.py" plan <campaign-id>
```

2. Profile default: `environment/claude-code/autonomy/profiles/pr-convergence.json`.
