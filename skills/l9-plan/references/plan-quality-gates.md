...
| G_PLAN_KERNEL_PASS | `.plan.md` missing `kernel_pass` / improve / recursive_alignment / validate_repair |
...
| G_PLAN_ORDER | Improve then Recursive Alignment then Validate & Repair `ran_at` is not strictly increasing |
