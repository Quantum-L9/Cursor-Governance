...
tags: [plan, todo, risks, estimate, milestones, checkpoints, validation]
status: active
version: 2.1.0
updated: 2026-08-02
/L9_META -->
...
7. Build checklist tied to TODOs.
8. Identify risks and mitigations.
9. Define Final Validation (mandatory) — post-implementation gates.
10. Estimate and recommend next skill (`l9-ynp`).
...
- **Every plan** MUST include Pre-Validation and Final Validation sections.
