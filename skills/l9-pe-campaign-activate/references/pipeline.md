...
| plan-window | inside activate, after stack-proof and before emit: write `$HOME/.l9/primed/<id>/nuggets.json`; refuse seal unless `plan_status` is Ready or ConditionallyReady. Not a new UNTIL_STAGE. |
