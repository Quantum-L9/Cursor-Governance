...
| `l9-update-agent-docs` / module READMEs | After `filetree.md`, write missing module and submodule `README.md` files via `scripts/generate_module_readmes.py` (AST only). Refresh only files that already carry `<!-- l9-module-readme: generated-from-ast -->`. Do not hand-write a generated module README. Optional sequencer: `readme-pipeline-v1`. |
