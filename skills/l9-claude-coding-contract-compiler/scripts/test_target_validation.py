...
class TargetValidationTests(unittest.TestCase):
    ...
    def test_python_has_no_implicit_npm_and_predecessor_proof_is_bound(self):
        ...
        c1, c2 = contracts
        self.assertIn(
            c1["git_workflow"]["completion_proof"], c2["resume_from"]["verify_before_starting"]
        )
        ...
        predecessor_repo_only = [
            cmd
            for cmd in c1["commit_gate"]["required_before_commit"]
        ...
        self.assertIn(
            c1["git_workflow"]["commit_subject"],
    ...
    def test_emitter_has_no_ecosystem_fallback_literals(self):
        ...
        for forbidden in [
            ...
            self.assertNotIn(
                forbidden, source, f"implicit ecosystem fallback reintroduced: {forbidden}"
            )
