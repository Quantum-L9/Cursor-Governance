---
name: l9-pr-digest
description: digest one PR into evidence, scope, and a bounded remediation
  packet without modifying it. use when judging agent PR scope before
  remediation or running the pre-remediation quality gate.
metadata:
  skill_schema: 1
  layer: control_plane
