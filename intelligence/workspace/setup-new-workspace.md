...
# Expected: failures/, patterns/, solutions/, n8n_lessons_learned/, etc.
...
test -d ".cursor-commands/learning/n8n_lessons_learned" && test -f ".cursor-commands/learning/n8n_lessons_learned/Recursive_Self_Check_Protocol.md" && echo "✅ n8n lessons folder accessible (1 file)" || echo "❌ Missing"
...
- ✅ All 4 subdirectories present (failures, patterns, solutions, n8n_lessons_learned)
