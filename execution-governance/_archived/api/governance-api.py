...
def add_rule():
    ...
    try:
        ...
        return jsonify(
            {"success": True, "rule_id": rule_data["id"], "message": "Rule added successfully"}
        )
    except Exception as e:
        return jsonify({"error": str(e)}), 500
...
if __name__ == "__main__":
    ...
    print("📊 Dashboard integration: Enhanced")
    print(f"🔗 Rule registry: {l9_governance_root / 'foundation' / 'logic' / 'rule-registry.json'}")
    print("🌐 Health check: http://localhost:8080/governance/health")
