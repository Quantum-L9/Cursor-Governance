...
echo "[$(date)] Step 5/6: Refreshing Pre-Execution Checker Cache..." >> "$LOG_FILE"
...
echo "[$(date)] Step 6/6: Updating Memory Compounding Weights..." >> "$LOG_FILE"
