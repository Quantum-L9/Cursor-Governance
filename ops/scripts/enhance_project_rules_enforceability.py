...
class RuleEnhancer:
    ...
    def _convert_to_mandates(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if any(keyword in line.lower() for keyword in ['mandatory', 'required', 'critical', 'must']):
    ...
    def _strengthen_language(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if not in_code_block and not in_example:
                ...
                if any(keyword in line.lower() for keyword in ['mandatory', 'required', 'critical']):
...
if __name__ == '__main__':
    workspace = Path("/Users/ib-mac/Dropbox/Prompt_Repo_IB/L9-Agent-Prompt-Insanity/L9 Reasoning Agent V1.0")
