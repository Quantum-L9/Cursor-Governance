    ...
    if _governed_model():
        return {
            ...
            "reason": (
                ...
                "Verification lives at `make pr` (Diagnose: `OPEN_PR=0 make pr`; "
                "the direct `run_pr_gate.sh` implementation), not at commit time. "
                ...
                "which keeps the surface-aware SKIP list a raw shim would drop."
            ),
        }
    return {
        "armed": False,
